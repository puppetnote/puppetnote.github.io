import svgPaths from "./svg-qhrdjzr062";

function Group() {
  return (
    <div className="absolute h-[8px] left-[105px] top-[216px] w-[129px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 129 8">
        <g id="Group 123550">
...
function BannerContainer() {
  return (
    <div className="absolute bg-[#e2f0ff] border border-[#e6e6e6] border-solid h-[236px] left-[16px] overflow-clip rounded-[30px] top-[146px] w-[342px]" data-name="Banner Container">
      <Group />
    </div>
  );
}
...
export default function Nz() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="nz">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Merriweather:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[186.5px] text-[15px] text-black text-center top-[105.5px] tracking-[-0.15px] uppercase w-[117px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[1.5]">뉴질랜드</p>
      </div>
