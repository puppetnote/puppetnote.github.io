import svgPaths from "./svg-l4oltji7l";
import imgBannerContainer from "./4ac0bcc366969053ad988dd4a267210216f84407.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[123px] top-[216px] w-[96px]">
...
export default function Bulgaria() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="bulgaria">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Merriweather:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[186.5px] text-[15px] text-black text-center top-[105.5px] tracking-[-0.15px] uppercase w-[117px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[1.5]">불가리아</p>
      </div>
