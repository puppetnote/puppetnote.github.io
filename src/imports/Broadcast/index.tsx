import svgPaths from "./svg-0tajamwhw7";
import imgBannerContainer from "./38b89b31c0aab2a290d5e2c2bb994bb27b7b416d.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[139px] top-[218px] w-[63px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 63 8">
        <g id="Group 123545">
...
export default function Broadcast() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="broadcast">
