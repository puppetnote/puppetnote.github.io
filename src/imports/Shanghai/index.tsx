import svgPaths from "./svg-rlxvmq6fpc";
import imgBannerContainer from "./9a634f7f9d3fb8889a0866af2284dbe828c124eb.png";
...
export default function Shanghai() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="shanghai">
