import svgPaths from "./svg-zwuwlffb0u";
import imgBannerContainer from "./3bdb38e45266774e86b9d26da521d4e07fb73289.png";

function BannerContainer() {
  return (
    <div className="overflow-hidden absolute h-[236px] left-[16px] pointer-events-none rounded-[30px] top-[146px] w-[342px]" data-name="Banner Container">
...
export default function Turkey() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="turkey">
