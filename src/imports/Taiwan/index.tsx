import svgPaths from "./svg-tn0eudx2qc";
import imgBannerContainer from "./70ab81fcd156a29e21e0fcc5c0a354f29d7fa598.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[161px] top-[222px] w-[19px]">
...
export default function Taiwan() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="taiwan">
