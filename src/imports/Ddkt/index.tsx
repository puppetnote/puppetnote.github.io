  ...
  return (
    <div className="bg-white relative size-full" data-name="ddkt">
      ...
      <div className="[word-break:break-word] absolute font-['Inter:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[0] left-[30px] not-italic text-[#626262] text-[11px] top-[396px] w-[327px] whitespace-pre-wrap">
        ...
        <p className="leading-[27px] mb-0">{`스스로 느낄 수 있도록 하면서도 동시에 짧고 코믹한 드라마의 구성으로 `}</p>
        <p className="leading-[27px] mb-0">
        ...
        <p className="leading-[27px] mb-0">{`반응을 유도 하면서 호흡 하는 것이 목적이며 자칫 감상만으로 그쳤을 때 집중도가 짧은 아이들의 산만함을 방지 하기 위하여 반복적이면서도 `}</p>
        <p className="leading-[27px] mb-0">{`아이들의 반응을 유도 할 수 있는 `}</p>
        <p className="leading-[27px] mb-0">{`여러가지 슬래스틱 코믹 액션을 집어 넣어 함께 하는 공연으로의 `}</p>
        <p className="leading-[27px] mb-0">
          완성도를 높여주었습니다.
          <br aria-hidden />
          <br aria-hidden />
