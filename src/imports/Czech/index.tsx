import svgPaths from "./svg-8r8qr6iixo";
import imgBannerContainer from "./c5f041f3c4246435e2edc506a0eaa293b1368fc8.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[161px] top-[218px] w-[19px]">
  ...
  return (
    <div className="absolute h-[236px] left-[16px] rounded-[30px] top-[146px] w-[342px]" data-name="Banner Container">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
        <img alt="" className="absolute h-[144.92%] left-[0.11%] max-w-none top-[-7.59%] w-full" src={imgBannerContainer} />
      </div>
...
export default function Czech() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="czech">
