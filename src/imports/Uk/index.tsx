import svgPaths from "./svg-6v1w0un162";
import imgBannerContainer from "./6338e7003e9252dbae02519a6bbf9bd760f44b21.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[134px] top-[219px] w-[74px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 74 8">
        <g id="Group 123550">
  ...
  return (
    <div className="absolute h-[236px] left-[16px] rounded-[30px] top-[146px] w-[342px]" data-name="Banner Container">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
        <img alt="" className="absolute h-[144.92%] left-[0.1%] max-w-none top-0 w-full" src={imgBannerContainer} />
      </div>
...
export default function Uk() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="uk">
