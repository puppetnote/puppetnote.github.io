import svgPaths from "./svg-uqk5j5rnnt";
import imgBannerContainer from "./a952b5f942f86c6c9eb9c3a5e38a5865ffb55b62.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[145px] top-[219px] w-[52px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 52 8">
        <g id="Group 123550">
...
export default function Harbin() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="harbin">
