import svgPaths from "./svg-kunjcqqzii";
import imgBannerContainer from "./d2b2f9a76d65d1fc0bbb00aed397795e3c59c2ba.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[123px] top-[217px] w-[96px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 8">
        <g id="Group 123550">
  ...
  return (
    <div className="absolute h-[236px] left-[16px] rounded-[30px] top-[146px] w-[342px]" data-name="Banner Container">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
        <img alt="" className="absolute h-[144.92%] left-[-0.03%] max-w-none top-[-3.06%] w-full" src={imgBannerContainer} />
      </div>
...
export default function Moscow() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="moscow">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Merriweather:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[186.5px] text-[15px] text-black text-center top-[105.5px] tracking-[-0.15px] uppercase w-[117px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[1.5]">모스크바</p>
      </div>
