import svgPaths from "./svg-ddlky0kh8a";
import imgBannerContainer from "./28232eedade87c42edd78c139e54f492f1e86697.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[106px] top-[217px] w-[129px]">
...
export default function Xinshanghai() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="xinshanghai">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Merriweather:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[186.5px] text-[15px] text-black text-center top-[105.5px] tracking-[-0.15px] uppercase w-[117px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[1.5]">중국 신천지</p>
      </div>
