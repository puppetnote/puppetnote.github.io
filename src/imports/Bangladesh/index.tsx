import svgPaths from "./svg-ju26erwcpl";
import imgBannerContainer from "./0c967b8693524cd7068c6f09b1a99380859e4c8b.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[161px] top-[220px] w-[19px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 8">
        <g id="Group 123550">
  ...
  return (
    <div className="absolute h-[236px] left-[16px] rounded-[30px] top-[146px] w-[342px]" data-name="Banner Container">
      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[30px]">
        <img alt="" className="absolute h-[144.92%] left-[-0.1%] max-w-none top-[-15.13%] w-full" src={imgBannerContainer} />
      </div>
...
export default function Bangladesh() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="bangladesh">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Merriweather:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[186.5px] text-[15px] text-black text-center top-[105.5px] tracking-[-0.15px] uppercase w-[117px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[1.5]">방글라데시</p>
      </div>
