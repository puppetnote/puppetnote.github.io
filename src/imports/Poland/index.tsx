import svgPaths from "./svg-3k62dqomwy";
import imgBannerContainer from "./78aee8a9e2bde21c57e536f26c32e2cf8f1681d1.png";

function Group() {
  return (
    <div className="absolute h-[8px] left-[150px] top-[217px] w-[41px]">
...
export default function Poland() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="poland">
