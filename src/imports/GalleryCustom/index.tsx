import svgPaths from "./svg-vry25yt5o1";
import imgBannerContainer from "./b72ecce6fa63f752bb793cf06e79ba2ec2212d15.png";
...
export default function GalleryCustom() {
  return (
    <div className="bg-white border border-[#e6e6e6] border-solid overflow-clip relative rounded-[30px] size-full" data-name="gallery_custom">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Merriweather:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[186.5px] text-[15px] text-black text-center top-[105.5px] tracking-[-0.15px] uppercase w-[117px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[1.5]">주문제작</p>
      </div>
